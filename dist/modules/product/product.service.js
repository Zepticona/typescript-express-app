...
const updateProductInDB = (id, productUpdate) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield product_model_1.default.findByIdAndUpdate(id, productUpdate, {
        new: true,
    });
    return result;
});
...
const searchProductFromDB = (products, query) => {
    const result = product_model_1.default.getSearchResults(products, query);
    return result;
};
exports.default = {
    createProductIntoDB,
